...
public final class TransformationMatrix {
   ...
   private static final TransformationMatrix field_227982_g_ = PortUtil.func_199748_a(() -> {
   ...
   private void func_227990_e_() {
      if (!this.field_227977_b_) {
         ...
         Triple<Quaternion, Vector3f, Quaternion> triple = pair.getLeft().func_226116_b_();
         this.field_227978_c_ = pair.getRight();
   ...
   private static Matrix4f func_227986_a_(@Nullable Vector3f p_227986_0_, @Nullable Quaternion p_227986_1_, @Nullable Vector3f p_227986_2_, @Nullable Quaternion p_227986_3_) {
      ...
      if (p_227986_2_ != null) {
         matrix4f.func_226595_a_(Matrix4f.func_226593_a_(p_227986_2_.func_195899_a(), p_227986_2_.func_195900_b(), p_227986_2_.func_195902_c()));
      }
      ...
      if (p_227986_0_ != null) {
         matrix4f.m03 = p_227986_0_.func_195899_a();
         matrix4f.m13 = p_227986_0_.func_195900_b();
         matrix4f.m23 = p_227986_0_.func_195902_c();
      }
